...
function Classes() {
  return (
    <div className="mt-12 grid grid-cols-1 gap-5 text-left 3xl:grid-cols-4">
      ...
      >
        <div
          className={`${bgStyles}  bg-[url('./images/featured-class/cycling.jpg')]`}
        ></div>
        <div className="absolute bottom-0 z-10 mb-5 ml-5 cursor-text space-y-2 text-white">
          ...
          <p className="bg-orange px-3 py-0.5">Wednesday: 9:00am-10:00am</p>
        </div>
      </div>
      ...
      >
        ...
        ></div>
        <div className="absolute bottom-0 z-10 mb-5 ml-5 cursor-text space-y-2 text-white">
          <h4 className="text-3xl font-bold">Crossfit</h4>
          <p className="whitespace-nowrap bg-orange px-3 py-0.5">
      ...
      >
        <div
          className={`${bgStyles} bg-[url('./images/featured-class/power.jpg')]`}
        ></div>
        <div className="absolute bottom-0 z-10 mb-5 ml-5 cursor-text space-y-2 text-white">
      ...
      >
        <div
          className={`${bgStyles} bg-[url('./images/featured-class/martial-arts.jpg')]`}
        ></div>
        <div className="absolute bottom-0 z-10 mb-5 ml-5 cursor-text space-y-2 text-white">
          <h4 className="text-3xl font-bold">Boxing Arts</h4>
          <p className="whitespace-nowrap bg-orange px-3 py-0.5">
      ...
      >
        <div
          className={`${bgStyles} bg-[url('./images/featured-class/workout.jpg')]`}
        ></div>
        <div className="absolute bottom-0 z-10 mb-5 ml-5 cursor-text space-y-2 text-white">
          <h4 className="text-3xl font-bold">Workout</h4>
          <p className="bg-orange px-3 py-0.5">Monday: 4:00pm-5:00pm</p>
        </div>
      </div>
    </div>
  );
