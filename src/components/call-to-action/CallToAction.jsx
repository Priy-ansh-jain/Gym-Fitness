...
function CallToAction() {
  return (
    <section className="relative z-[1] flex justify-center bg-[url('./images/call-to-action/bg.jpg')] bg-cover bg-[20%] text-center 2xl:bg-center 2xl:text-left opacity-60">
