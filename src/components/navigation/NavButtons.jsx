...
const btnStyles = `hover:text-orange text-white transition-colors duration-300 focus`;
  ...
  return (
    <div className="flex items-center justify-between gap-7">
      ...
      <div className="focus hidden rounded-sm border-2 border-solid border-gray-350 p-1.5 lg:block">
        ...
        >
          <FaPlus className="h-8 w-8 rounded-sm bg-orange p-2 text-white transition-transform duration-1000 hover:rotate-[360deg]" />
          Join class now
        </Link>
      </div>
    </div>
