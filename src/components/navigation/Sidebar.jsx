    ...
    >
      ...
      <section className="space-y-4">
        ...
        <div className="flex flex-col items-start gap-2">
          <Link
            to="/"
            className="focus flex items-center gap-2 font-medium text-gray-400 transition-colors duration-300 hover:text-orange"
          >
          ...
          <Link
            ...
            className="focus flex items-center gap-2 font-medium text-gray-400 transition-colors duration-300 hover:text-orange"
          >
            <FaPhone className="text-orange" /> (+91) 9584298722
          </Link>
          <Link
            to="boxi:example@gymBox.com"
            className="focus flex items-center gap-2 font-medium text-gray-400 transition-colors duration-300 hover:text-orange"
          >
            <FaEnvelope className="text-orange" /> example@gymBox.com
          </Link>
        </div>
      </section>
      <section className="space-y-4">
        ...
        <div className="flex gap-3">
          <Link className="rounded-full bg-orange p-3 text-white">
